...
export const Layout: React.FC<LayoutProps> = ({
  children,
  title = 'MathVerse - Animation-First Mathematics Learning Platform',
  description = 'Transform your math learning experience with beautiful animations and interactive visualizations',
}) => {
  return (
    <>
      <Head>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div className="col-span-1 md:col-span-2">
                ...
                <p className="text-gray-600 max-w-md">
                  Transforming mathematics education through beautiful, interactive animations.
                  Learn complex concepts with clarity and confidence.
                </p>
                <div className="flex space-x-4 mt-6">
                  <a
                    href="https://twitter.com/mathverse"
                    target="_blank"
                  ...
                  <a
                    href="https://github.com/mathverse"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-400 hover:text-gray-600 transition-colors"
                  >
                  ...
                  <a
                    href="https://linkedin.com/company/mathverse"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-400 hover:text-gray-600 transition-colors"
                  >
            ...
            <div className="border-t border-gray-200 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
              <p className="text-sm text-gray-500">
                © {new Date().getFullYear()} MathVerse. All rights reserved.
              </p>
